...
#%%
fig = pl.plot_tracks_by_id(movie488, stats_488, df_488, [6080], 108)
# fig.savefig(r'D:\Data\my_plot.pdf') 
#%%
fig = pl.plot_coloc_by_id(movie488, df_coloc_hdf, df_coloc_csv, [74, 248], 108)
#%%
fig = pl.intensity_coloc(df_coloc_csv, movie488, movie638, 74, 108)
...
fig = pl.box_D_condition(Ds, to_plot)
...
fig = pl.hist_dwell(dw, to_plot, False, None, 0)
